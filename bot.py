...
Introduce_Ans = ["My name is Ayush's Bot.","My name is Ayush's Bot you can called me pi.","Im Ayush's Bot :) ","My name is Ayush's Bot. and my nickname is pi and i am happy to solve your queries :) "]
